...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
        ...
        type: json["type"] ?? "",
        deliveryFrom:
            DateTime.parse(json["delivery_from"] ?? DateTime.now().toString()),
        deliveryTo:
            DateTime.parse(json["delivery_to"] ?? DateTime.now().toString()),
...
class Items {
  ...
  factory Items.fromJson(Map<String, dynamic> json) => Items(
        assignedPicker: json["assigned_picker"] == null
            ? []
            : List<EndPicking>.from(
                json["assigned_picker"]!.map((x) => EndPicking.fromJson(x))),
        endPicking: json["end_picking"] == null
            ? []
            : List<EndPicking>.from(
        ...
        itemNotAvailable: json["item_not_available"] == null
            ? []
            : List<EndPicking>.from(
                json["item_not_available"]!.map((x) => EndPicking.fromJson(x))),
        holded: json["holded"] == null
            ? []
            : List<EndPicking>.from(
                json["holded"]!.map((x) => EndPicking.fromJson(x))),
        startPicking: json["start_picking"] == null
            ? []
            : List<EndPicking>.from(
  ...
  Map<String, dynamic> toJson() => {
        "assigned_picker": assignedPicker == null
            ? []
