...
class _PhotographyDashboardState extends State<PhotographyDashboard>
  ...
  Future<void> scanBarcodeNormal(BuildContext ctx) async {
    ...
    try {
      ...
      if (producebarcode) {
        ...
        log("Processed SKU for produce: $barcodescanRes");

        // Get price from barcode
        // processedPrice = getPriceFromBarcode(barcodescanRes!);
      }

      final productresponse = await widget.serviceLocator.tradingApi
          .generalProductServiceGet(endpoint: barcodescanRes!);
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: 90.0,
                              child:
                                  _productResponse!.data.isEmpty ||
                                          _productResponse!.data[0].image == ""
  ...
  Future<void> scanBarcodeManuall(BuildContext ctx, String barcode) async {
    try {
      ...
      final productresponse = await widget.serviceLocator.tradingApi
          .generalProductServiceGet(endpoint: barcode);
  ...
  getImageViewver(
    List<AdditionalImage> imageList,
    context,
