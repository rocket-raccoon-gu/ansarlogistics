...
class PickedItemsPage extends StatefulWidget {
  ...
  @override
  State<PickedItemsPage> createState() => _PickedItemsPageState();
}

class _PickedItemsPageState extends State<PickedItemsPage> {
  @override
            ...
            itemBuilder: (context, index) {
              ...
              return itemslist.isNotEmpty
                  ? PickerOrderItem(
                    ...
                    itemslistbackcategories: widget.pickeditems,
                  )
                  : SizedBox();
            },
          ),
